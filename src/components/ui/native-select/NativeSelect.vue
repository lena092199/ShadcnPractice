...
<template>
  <div class="group/native-select relative has-[select:disabled]:opacity-50" data-slot="native-select-wrapper">
    ...
    <ChevronDownIcon
      class="text-muted-foreground pointer-events-none absolute top-1/2 right-6 size-4 -translate-y-1/2 opacity-50 select-none"
